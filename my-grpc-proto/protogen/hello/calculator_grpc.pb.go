...
const (
	...
	Calculator_PrimeNumDecompose_FullMethodName = "/Calculator/PrimeNumDecompose"
	Calculator_Average_FullMethodName           = "/Calculator/Average"
	Calculator_FindMax_FullMethodName           = "/Calculator/FindMax"
)
...
type CalculatorClient interface {
	...
	PrimeNumDecompose(ctx context.Context, in *PNDRequest, opts ...grpc.CallOption) (Calculator_PrimeNumDecomposeClient, error)
...
func (c *calculatorClient) PrimeNumDecompose(ctx context.Context, in *PNDRequest, opts ...grpc.CallOption) (Calculator_PrimeNumDecomposeClient, error) {
	stream, err := c.cc.NewStream(ctx, &Calculator_ServiceDesc.Streams[0], Calculator_PrimeNumDecompose_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &calculatorPrimeNumDecomposeClient{stream}
...
type Calculator_PrimeNumDecomposeClient interface {
	Recv() (*SumResponse, error)
	grpc.ClientStream
}

type calculatorPrimeNumDecomposeClient struct {
	grpc.ClientStream
}

func (x *calculatorPrimeNumDecomposeClient) Recv() (*SumResponse, error) {
	m := new(SumResponse)
...
func (c *calculatorClient) FindMax(ctx context.Context, opts ...grpc.CallOption) (Calculator_FindMaxClient, error) {
	stream, err := c.cc.NewStream(ctx, &Calculator_ServiceDesc.Streams[2], Calculator_FindMax_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
type Calculator_FindMaxClient interface {
	Send(*FMaxRequest) error
	Recv() (*FMaxResponse, error)
	grpc.ClientStream
}
...
func (x *calculatorFindMaxClient) Send(m *FMaxRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *calculatorFindMaxClient) Recv() (*FMaxResponse, error) {
	m := new(FMaxResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type CalculatorServer interface {
	...
	PrimeNumDecompose(*PNDRequest, Calculator_PrimeNumDecomposeServer) error
...
func (UnimplementedCalculatorServer) PrimeNumDecompose(*PNDRequest, Calculator_PrimeNumDecomposeServer) error {
	return status.Errorf(codes.Unimplemented, "method PrimeNumDecompose not implemented")
}
...
func _Calculator_PrimeNumDecompose_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(PNDRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(CalculatorServer).PrimeNumDecompose(m, &calculatorPrimeNumDecomposeServer{stream})
}

type Calculator_PrimeNumDecomposeServer interface {
	Send(*SumResponse) error
	grpc.ServerStream
}

type calculatorPrimeNumDecomposeServer struct {
	grpc.ServerStream
}

func (x *calculatorPrimeNumDecomposeServer) Send(m *SumResponse) error {
...
type Calculator_FindMaxServer interface {
	Send(*FMaxResponse) error
	Recv() (*FMaxRequest, error)
	grpc.ServerStream
}
...
func (x *calculatorFindMaxServer) Send(m *FMaxResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *calculatorFindMaxServer) Recv() (*FMaxRequest, error) {
	m := new(FMaxRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var Calculator_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "PrimeNumDecompose",
			Handler:       _Calculator_PrimeNumDecompose_Handler,
			ServerStreams: true,
		},
		{
			StreamName:    "Average",
	...
	Metadata: "proto/hello/calculator.proto",
}
